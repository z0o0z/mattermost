...
describe('ChannelSettingsAccessRulesTab - Activity Warning Integration', () => {
    ...
    const mockActions = {
        ...
        dismissChannelActivityWarning: jest.fn().mockResolvedValue({data: {status: 'success'}}),
    ...
    it('should not show activity warning when user preference is dismissed', async () => {
        ...
        const stateWithDismissedPreference = {
            entities: {
                ...
                preferences: {
                    myPreferences: {
                        'advanced_settings--abac_activity_warning_dismissed_channel_id': {
                            user_id: 'current_user_id',
                            category: 'advanced_settings',
                            name: 'abac_activity_warning_dismissed_channel_id',
                            value: 'true',
                        },
                    },
                },
